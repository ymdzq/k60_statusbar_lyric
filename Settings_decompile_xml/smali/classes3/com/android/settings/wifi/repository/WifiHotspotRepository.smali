...
# direct methods
.method public static synthetic $r8$lambda$IH4E3eS9Snz3zEgrBjTZNCKQBBc(Lcom/android/settings/wifi/repository/WifiHotspotRepository;)V
    .locals 0
...
.method private setRestarting(Z)V
    ...
    const-string/jumbo v1, "setRestarting(), isRestarting:"
...
.method public setSecurityType(I)V
    ...
    const-string/jumbo v1, "setSecurityType():"
    ...
    const-string/jumbo v0, "setSecurityType() is no changed! mSecurityType:"
    ...
    const-string/jumbo p0, "setSecurityType(), WifiManager#getSoftApConfiguration() return null!"
...
.method public setSpeedType(I)V
    ...
    const-string/jumbo v1, "setSpeedType():"
    ...
    const-string/jumbo v0, "setSpeedType() is no changed! mSpeedType:"
    ...
    const-string/jumbo p0, "setSpeedType(), WifiManager#getSoftApConfiguration() return null!"
    ...
    const-string/jumbo p1, "setSpeedType(), setBand(BAND_2GHZ_5GHZ_6GHZ)"
    ...
    const-string/jumbo p1, "setSpeedType(), setPassphrase(SECURITY_TYPE_WPA3_SAE)"
    ...
    const-string/jumbo p1, "setSpeedType(), setBand(BAND_2GHZ_5GHZ)"
    ...
    const-string/jumbo p1, "setSpeedType(), setBands(BAND_2GHZ + BAND_2GHZ_5GHZ)"
    ...
    :cond_5
    const-string/jumbo p1, "setSpeedType(), setBand(BAND_2GHZ)"
...
.method protected startAutoRefresh()V
    ...
    :cond_0
    const-string/jumbo v0, "startMonitorSoftApConfiguration()"
...
.method protected stopAutoRefresh()V
    ...
    :cond_0
    const-string/jumbo v0, "stopMonitorSoftApConfiguration()"
...
.method protected updateSecurityType()V
    ...
    const-string/jumbo v2, "updateSecurityType(), securityType:"
...
.method protected updateSpeedType()V
    ...
    const-string/jumbo v3, "updateSpeedType(), getBand():"
    ...
    const-string/jumbo v2, "updateSpeedType(), keyBand:"
