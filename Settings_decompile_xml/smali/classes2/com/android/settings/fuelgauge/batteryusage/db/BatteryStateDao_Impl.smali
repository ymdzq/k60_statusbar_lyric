...
.method public getCursorSinceLastFullCharge(J)Landroid/database/Cursor;
    .locals 2

    const-string v0, "SELECT * FROM BatteryState WHERE timestamp >= ? AND timestamp >= (SELECT IFNULL((SELECT MAX(timestamp) FROM BatteryState WHERE isFullChargeCycleStart = 1), 0)) ORDER BY timestamp ASC"
