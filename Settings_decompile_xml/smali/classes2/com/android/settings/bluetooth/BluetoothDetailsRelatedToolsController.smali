...
.method private addAccessibilityInstalledRelatedPreference(Ljava/util/List;)V
    ...
    .line 117
    invoke-virtual {v1, v2, v0}, Lcom/android/settings/accessibility/RestrictedPreferenceHelper;->createAccessibilityServicePreferenceList(Ljava/util/List;Z)Ljava/util/List;

    move-result-object v2

    .line 118
    invoke-virtual {v1, p1, v0}, Lcom/android/settings/accessibility/RestrictedPreferenceHelper;->createAccessibilityActivityPreferenceList(Ljava/util/List;Z)Ljava/util/List;

    move-result-object p1

    filled-new-array {v2, p1}, [Ljava/util/List;
